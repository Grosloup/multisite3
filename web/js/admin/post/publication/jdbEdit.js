var jdbEditApp = angular.module("JdbEditApp",['PostDataApp', 'CategoryFactory','TagFactory']);

jdbEditApp.controller("JdbController", ['$scope','$window','$postDatas','$categories','$tags', function($scope,$window, $postDatas,$categories,$tags){
    var target = "jdb";
