var hdbEditApp = angular.module("HdbEditApp",['PostDataApp', 'CategoryFactory','TagFactory']);

hdbEditApp.controller("HdbController", ['$scope','$window','$postDatas','$categories','$tags', function($scope,$window, $postDatas,$categories,$tags){
    var target = "hdb";
