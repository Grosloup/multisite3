var bnEditApp = angular.module('BnEditApp',['PostDataApp']);


bnEditApp.controller('BnController',['$scope','$window','$postDatas','$categories','$tags', function($scope,$window, $postDatas,$categories,$tags){
    var target = "bn";
