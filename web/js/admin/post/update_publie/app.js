$(function(){
    ...
    var  iptTitle = $("#update_post_form_title"), saveBtn = $("#update_post_form_save");
    ...
    $("textarea[data-editor]").each(function(){
        ...
        if(editor.getSession().getValue().length>0){
            if($(this).attr("id")== "update_post_form_excerpt"){
                validObj.excerpt = true;
                enableEdition();
            }
            if($(this).attr("id")== "update_post_form_body"){
                validObj.body = true;
                enableEdition();
            }
        }
